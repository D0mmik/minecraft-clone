...
function drawPixel(ctx: CanvasRenderingContext2D, x: number, y: number, r: number, g: number, b: number, a = 255): void {
...
function drawGrassSide(ctx: CanvasRenderingContext2D, ox: number, oy: number): void {
...
function drawWoodTop(ctx: CanvasRenderingContext2D, ox: number, oy: number): void {
...
function drawWoodSide(ctx: CanvasRenderingContext2D, ox: number, oy: number): void {
...
function drawLeaves(ctx: CanvasRenderingContext2D, ox: number, oy: number): void {
...
function drawSnow(ctx: CanvasRenderingContext2D, ox: number, oy: number): void {
...
type DrawFn = (ctx: CanvasRenderingContext2D, ox: number, oy: number) => void;

const drawFunctions: DrawFn[] = [
  drawGrassTop,     // 0
  drawGrassSide,    // 1
  drawDirt,         // 2
  drawStone,        // 3
...
export function getUVs(textureIndex: number): { u0: number; v0: number; u1: number; v1: number } {
